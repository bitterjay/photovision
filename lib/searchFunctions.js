    ...
    constructor() {
        ...
        this.functions = {
            ...
            intelligentSearch: {
                ...
                description: 'This is your go-to function for understanding and finding photos based on natural, conversational descriptions! It\'s perfect when users describe what they\'re looking for in their own words - like "kids having fun" or "that moment when someone won". Use this when the user sounds conversational or describes scenes, emotions, or memories rather than just listing keywords.',
                parameters: {
                    type: 'object',
                    properties: {
                        query: {
                            type: 'string',
                            description: 'The user\'s natural language description of what they want to find. Examples: "happy kids at a celebration", "athletes looking really focused and determined", "that exciting moment when someone wins", "people gathered together having a good time"'
                        },
                        maxResults: {
                            type: 'number',
                            description: 'Maximum number of results to return',
